...
- Built a custom Microsoft Sentinel monitoring dashboard
- Visualized authentication telemetry using KQL
- Monitored failed login activity using EventID 4625
- Created multiple workbook visualizations
- Learned how workbooks assist SOC monitoring and investigations

---

# 🔗 Next Step

Proceeding to create an Incident Management Dashboard for monitoring Sentinel incidents, alert severities, and incident metrics.
